...
commands["docs"] = function(args){
  window.open('https://book.koad.sh', 'koadiodocs'); // ...I'm sorry
  return `opened 'book.koad.sh' in browser window`;
};

commands["github"] = function(args){
  window.open('https://github.com/koad', 'github'); // ...I'm sorry
  return `opened 'github.com/koad' in browser window`;
};

commands["keybase"] = function(args){
  window.open('https://keybase.io/koad', 'koadlive'); // ...I'm sorry
